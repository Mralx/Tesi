...
import exploration.thesisStrategies.*;
import path.Path;
...
// <editor-fold defaultstate="collapsed" desc="Class variables and Constructors">    
    ...
    //Added for SideFollower
    private ArrayList<RealAgent> buddies;
    private String followerType;
    private Point startPoint;
    public static final String LEFT_FOLLOWER = "left";
    public static final String RIGHT_FOLLOWER = "right";
...
// <editor-fold defaultstate="collapsed" desc="Get and Set">
    ...
    public ArrayList<RealAgent> getBuddies() {
        return buddies;
    }

    public void setBuddies(ArrayList<RealAgent> buddies) {
        this.buddies = buddies;
    }

    public void addBuddy(RealAgent agent){
        this.buddies.add(agent);
    }
        ...
        if (oldTimeElapsed != timeElapsed)
        {
            ...
            switch(simConfig.getExpAlgorithm()) {
                ...
                case ProactiveReserve:
                                             nextStep = ProactiveReserve.takeStep(this,env);
                                             break;
                case ProactiveBuddySystem:
                                             nextStep = ProactiveBuddySystem.takeStep(this,env);
                                             break;
                case SideFollower:
                                             nextStep = SideFollower.takeStep(this,env);
                                             break;
                default:                     break;
            }
        } else
