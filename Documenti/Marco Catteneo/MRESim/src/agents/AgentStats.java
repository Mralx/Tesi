...
public class AgentStats {
    ...
    private double stepInterference;
    private double stepAvailability;
    ...
    public double getStepInterference() {
        return stepInterference;
    }

    public void setStepInterference(double stepInterference) {
        this.stepInterference = stepInterference;
    }

    public double getStepAvailability() {
        return stepAvailability;
    }

    public void setStepAvailability(double stepAvailability) {
        this.stepAvailability = stepAvailability;
    }

    public long getDecisionStartTime() {
        return decisionStartTime;
    }

    public void setDecisionStartTime(long decisionStartTime) {
