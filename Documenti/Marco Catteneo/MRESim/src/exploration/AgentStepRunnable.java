    ...
    public void run() 
    {
        ...
        while (distance_left > 0)
        {
            ...
            if(simConfig.getExpAlgorithm() == SimulatorConfig.exptype.valueOf("Reserve") ||
                    ...
                    simConfig.getExpAlgorithm() == SimulatorConfig.exptype.valueOf("ProactiveReserve") ||
                    simConfig.getExpAlgorithm() == SimulatorConfig.exptype.valueOf("ProactiveBuddySystem") ||
                    simConfig.getExpAlgorithm() == SimulatorConfig.exptype.valueOf("SideFollower") ||
                    simConfig.getExpAlgorithm() == SimulatorConfig.exptype.valueOf("FrontierExploration")){
